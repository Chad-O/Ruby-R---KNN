#INTEGRANTES
#Victor Andres Bautista Aguilar 20192461
#Mauricio Sebastian Cisneros Laule 20192624
#Marco Antonio Landauro Alba 20191063
#Jean Pierre Soto Tipacti 20191946
##############LIBRERIAS###########################################
require 'csv'
require 'matrix'
############### RECIBIR CSV ######################################
data = []
data = CSV.read("C:/Users/Mauricio/PycharmProjects/Ruby/i.csv")
############### FIN CSV ##########################################
